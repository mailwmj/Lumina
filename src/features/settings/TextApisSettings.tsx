  ...
  return (
    <>
      ...
      {apis.map((api) => {
        ...
        return (
          <section key={api.id} className="border-b border-[var(--ui-border-soft)] py-4">
              ...
              <div className="flex shrink-0 items-center gap-3">
                ...
                <UiTooltip content={t('settings.removeTextApi')}>
                  <button
                    ...
                    onClick={() => onChange(apis.filter((candidate) => candidate.id !== api.id))}
      ...
      <div className="py-4">
        <button
          type="button"
          onClick={() => onChange([...apis, createTextApiConfig()])}
